<div class="container-fluid header-bg py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container py-5">
        <h1 class="display-4 text-white mb-3 animated slideInDown text-center">Qayta aloqa</h1>
    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                <h1 class="display-6 mb-4 text-center">Takliflar va savollar uchun qayta aloqa</h1>
                <form>
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                ...
                                <label for="email">email pochta manzilingiz</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-floating">
