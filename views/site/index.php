    ...
    <div class="row g-0 flex-column-reverse flex-lg-row">
        <div class="col-lg-6 p-0 wow fadeIn" data-wow-delay="0.1s">
            <div class="header-bg h-100 d-flex flex-column justify-content-center p-5">
                <h1 class="display-4 text-light mb-5 text-center">Andijon viloyat tarixi va madaniyati davlat muzeyi</h1>
    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <?php endforeach; ?>
                <a class="btn btn-primary py-3 px-5 mt-3" href="<?=Url::to(['single-page','id'=>$aboutMuseum->id])?>">Batafsil</a>
            </div>
    ...
    <div class="container">
        <div class="row g-5 mb-5 align-items-end wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div class="col-lg-6 text-lg-end">
                <a class="btn btn-primary py-3 px-5" href="/site/eksponatlar">Ko'proq</a>
            </div>
        </div>
        <div class="row g-4">
            ...
            foreach ($events as $event): $i++ ?>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="membership-item position-relative" style="height: 400px;">
                        ...
                        <a class="btn btn-outline-light px-4 mt-3" href="<?=Url::to(['single-page','id'=>$event->id])?>">Batafsil</a>
                    </div>
                </div>
            <?php endforeach; ?>
